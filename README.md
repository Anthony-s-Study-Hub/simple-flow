...
evidence, and writes JSON plus Markdown experiment reports. Source CI validates
the harness and scenario catalog statically; it does not run live Codex
...
Run the live Phase 4 experiment explicitly:
